          ...
          <nav class="mt-4">
            <ul
              ...
              <?php if ($_SESSION['type'] = 1): ?>
                ...
                <li class="nav-item dropdown">
                  <a href="<?php echo base_url ?>admin/?page=addons" class="nav-link nav-addons">
              ...
              <li class="nav-item dropdown">
                <a href="<?php echo base_url ?>admin/?page=content_management" class="nav-link nav-system_info">
